from classes import Augmentation, FactionNames, AugmentationNames, Programs
...
augmentations = [
  ...
  Augmentation(
    ...
    factions = ["Technically in FactionNames.ChurchOfTheMachineGod but not really for display reasons"],
  ),
  Augmentation(
